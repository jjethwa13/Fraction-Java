...
public class Fraction {
    ...
    public String toString() {
        // Fill in this method.
    	if (denominator == 1) {
    		return int.toString(numerator);
    	}
    	else {
    		String f = int.toString(numerator) + "/" + int.toString(denominator);
    		return f;
    	}
    }
    ...
    public Fraction divide(Fraction f) {
        // Fill in this method.
    	int num = denominator * f.numerator;
    	int denom = numerator * f.denominator;
    ...
    private int gcd() {
    	...
    	if numerator >= denominator{
    		int LowestDigit = denominator;
    		int HighestDigit = numerator;
    	}
    	else {
    		int LowestDigit = numerator;
    		int HighestDigit = denominator;
    	}
    	for (int i = 1; i <= LowestDigit; i++) {
    		if ((LowestDigit % i) == 0) && ((HighestDigit % i) == 0) {
    			gcd = i;
    		}
    	}
